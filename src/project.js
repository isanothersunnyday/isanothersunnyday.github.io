            ...
            var a = e("./GameManager"),
                ...
                p = function(e) {
                    ...
                    return o(t, e), n = t, t.prototype.onLoad = function() {
                        ...
                        window.location.href = "https://weibo.com/u/1314749965"
            ...
            var a = e("GameConfig"),
                i = (c(o = {
                    ...
                    if (0 != this.cacheList.length) {
                        this.isBusy = !0, this.perform = this.cacheList.shift(), this.req = cc.loader.getXMLHttpRequest(), this.req.onreadystatechange = this.onDataHandler.bind(this), this.req.onerror = this.onErrorHandler.bind(this), this.req.ontimeout = this.onTimeoutHandler.bind(this), this.req.timeout = 2e3, cc.log("pos", this.URL), this.req.open("POST", "/"), this.req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=UTF-8");
        ...
        function(e, t, n) {
            ...
            t.exports = {
                language_1: {
                    ...
                    gameT2: "",
                    gameT3: "",
                    gameUrl1: "https://weibo.com/u/1314749965",
                    gameUrl2: "https://weibo.com/u/1314749965",
                    gameT11: "",
                    gameT12: "",
                    gameT13: "",
                    gameEndL: "",
        ...
        function(e, t, n) {
            ...
            cc.Class({
                ...
                RestartGame: function() {
                    o.GAME_OVER_BOOL = !0, o.gameScore = 0, cc.director.loadScene("MainGameScene")
                },
            ...
            var o = e("HttpManagerJs"),
                ...
                r = (e("GameUiTools"), {
                    ...
                    ajaxLoad: function(e, t, n) {
                        ...
                        o.onreadystatechange = n, o.open("get", "/"), o.setRequestHeader("Content-Type", "text/html"), o.send(t)
                    },
